...
export const ProjectApplyPage: React.FC = () => {
  ...
  const handleCancel = () => navigate(createProjectDetailPath(projectId ?? "1"));
  const handleSubmit = () => navigate(createProjectDetailPath(projectId ?? "1"));
    ...
    <div className="pa-page">
      ...
      <div className="pa-body">
        ...
        <div className="pa-left">
          ...
          <p className="pa-left__desc">프로젝트 상세 화면 위에 모달로 표시되는 지원 폼</p>
        ...
        <div className="pa-right">
          <div className="pa-field">
            ...
            <span className="pa-field__hint">읽기 전용 박스: 아바타/이름/역할/기술 태그/포트폴리오 링크</span>
          </div>

          <div className="pa-field">
            <label className="pa-field__label">지원할 역할</label>
            <input className="pa-input" readOnly value={role || "모집 중인 역할만 선택 가능"} />
            <span className="pa-field__hint">선택 칩(라디오/단일 선택), 비활성 상태 없음</span>
          </div>
          ...
          <div className="pa-field">
            ...
            />
            <span className="pa-field__hint">텍스트 영역 + {message.length}/300 카운터</span>
          </div>
        </div>
      </div>
      ...
      <div className="pa-actions">
        <button className="pa-btn pa-btn--cancel" onClick={handleCancel}>취소하기</button>
        <button className="pa-btn pa-btn--submit" onClick={handleSubmit}>지원 제출하기</button>
      </div>
